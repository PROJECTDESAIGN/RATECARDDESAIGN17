...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan Biru Benhur (#003399) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #003399}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#003399;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#003399;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#003399;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone biru soft (#F0F4FA) */
    '.info-box{background:#F0F4FA;border:1px solid #C2D4EE;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Biru Benhur (#003399) */
    '.paket-box{background:#003399;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#F8FAFC;border:1px solid #DEE8F5;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft royal blue (#E6EEFA) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#E6EEFA;border:1px solid #B0CAEF;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#002266;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #C2D4EE;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
